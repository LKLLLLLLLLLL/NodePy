...
"""
This file defines some node to drop some rows from a table.
"""
...
class DropDuplicatesNode(BaseNode):
    ...
    def infer_output_schemas(self, input_schemas: Dict[str, Schema]) -> Dict[str, Schema]:
        ...
        return {
            "deduplicated_table": table_schema
        }
    ...
    def process(self, input: Dict[str, Data]) -> Dict[str, Data]:
        ...
        return {
            "deduplicated_table": Data.from_df(deduplicated_df)
        }
    ...
    def hint(cls, input_schemas: Dict[str, Schema], current_params: Dict) -> Dict[str, Any]:
        ...
        return {
            "subset_col_choices": subset_col_choices
        }
...
class DropNaNValueNode(BaseNode):
    ...
    def process(self, input: Dict[str, Data]) -> Dict[str, Data]:
        ...
        return {
            "cleaned_table": Data.from_df(cleaned_df)
        }
