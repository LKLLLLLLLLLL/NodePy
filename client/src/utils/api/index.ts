...
export type { fastapi___compat__v2__Body_upload_file_api_files_upload__project_id__post } from './models/fastapi___compat__v2__Body_upload_file_api_files_upload__project_id__post';
