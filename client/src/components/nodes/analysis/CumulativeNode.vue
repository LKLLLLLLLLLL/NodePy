...
<script lang="ts" setup>
    ...
    import type { CumulativeNodeData } from '@/types/nodeTypes'


    const props = defineProps<NodeProps<CumulativeNodeData>>()
    ...
    const onSelectChangeMethod = (e: any) => {
        const selected_method = method[e] as 'cumsum' | 'cumprod' | 'cummax' | 'cummin'
