...
<script lang="ts" setup>
    ...
    import type { NumberColWithColBinOpNodeData } from '@/types/nodeTypes'


    const props = defineProps<NodeProps<NumberColWithColBinOpNodeData>>()
    const op = ["ADD", "SUB", "MUL", "DIV", "POW"]
    const opUi = ['加法', '减法', '乘法', '除法', '乘方']
...
<style lang="scss" scoped>
    ...
    .NumberColWithColBinOpNodeLayout {
        height: 100%;
        .data {
