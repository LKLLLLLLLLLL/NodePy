...
<script lang="ts" setup>
    ...
    import type { BatchRegexMatchNodeData } from '@/types/nodeTypes'
    ...
    watch(() => JSON.stringify(props.data.error), () => {
        ...
        handleParamError(props.data.error, errMsg, patternHasErr, colHasErr, result_colHasErr)
